...
/** @deprecated */
declare type FindNearestFileOptions = FindFileOptions;
...
declare type ResolveOptions = ResolveOptions$1 & FindFileOptions;
...
declare function resolveLockfile(id?: string, opts?: ResolveOptions): Promise<string>;
declare function findWorkspaceDir(id?: string, opts?: ResolveOptions): Promise<string>;

export { FindFileOptions, FindNearestFileOptions, PackageJson, PackageJsonPerson, ResolveOptions, StripEnums, TSConfig, definePackageJSON, defineTSConfig, findFarthestFile, findFile, findNearestFile, findWorkspaceDir, readPackageJSON, readTSConfig, resolveLockfile, resolvePackageJSON, resolveTSConfig, writePackageJSON, writeTSConfig };
